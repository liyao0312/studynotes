...
直接利用**类**的class静态属性：该方式不会让静态代码块执行
...
Class对象是反射的核心，一切反射都是从Class开始的

1. 创建Class对象所对应的那个类的对象：调用Class对象newInstance()方法

   ```java
   //2创建 Class 对象所对应的那个类的对象: 调用 Class 对象的 newInstance() 方法
...
2. 得到Class对象所对应的那个类中有哪些方法

   注意：类中的方法对应在反射中对应的类时：Method
